...
namespace UndoFramework
{
	...
	public class ActionManager
	{
		...
		/// </summary>
		/// <remarks><b>null</b> if no Undo or Redo is taking place.</remarks>
		...
		public Stack<Transaction> TransactionStack { get { return mTransactionStack; } }

		public Transaction RecordingTransaction
		{
			get
			{
				if(TransactionStack.Count<=0) return null;
		...
		public void CommitTransaction()
		{
			...
			if(committing.HasActions()) RecordAction(committing);
		}
		...
		public void RollBackTransaction()
		{
			if(TransactionStack.Count!=0)
			{
				...
				if(topLevelTransaction!=null) topLevelTransaction.UnExecute();
		...
		public bool CanUndo { get { return History.CanMoveBack; } }

		public bool CanRedo { get { return History.CanMoveForward; } }
		#endregion
		...
		/// <summary>
		/// Gets a <see cref="IEnumerable{IAction}"/> to the redo-able actions. Starting at the earliest entry, going forward in history.
		/// </summary>
		...
		/// <summary>
		/// Gets a <see cref="IEnumerable{IAction}"/> to the redo-able actions. Starting at the current position, going forward in history.
		/// </summary>
		public IEnumerable<IAction> RedoableActions { get { return History.RedoableActions; } }

		/// <summary>
		/// Gets a <see cref="IEnumerable{IAction}"/> to the undo-able actions. Starting at the current position, going backward in history.
		/// </summary>
		public IEnumerable<IAction> UndoableActions { get { return History.UndoableActions; } }
		...
		internal IActionHistory History
		{
			...
			set
			{
				if(mHistory!=null) mHistory.CollectionChanged-=RaiseUndoBufferChanged;
				mHistory=value;
				if(mHistory!=null) mHistory.CollectionChanged+=RaiseUndoBufferChanged;
			}
		}
